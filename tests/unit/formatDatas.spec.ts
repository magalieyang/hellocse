...
import { rawMovieDetailsData, rawMovieCreditsData, expectedMovieData } from '../__mocks__/movieData';
...
describe('formatData.ts', () => {
    ...
    describe('formatMovieData for overview', () => {
        it('should format single movie from raw movie details data and raw movie credits data', () => {
            const formattedData = formatMovieData({...rawMovieDetailsData, ...rawMovieCreditsData});
